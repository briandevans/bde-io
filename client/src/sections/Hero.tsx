      ...
      >
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex gap-8 md:gap-20 flex-wrap items-center opacity-40">
            ...
            <img src="/images/entrepreneur.svg" alt="Entrepreneur" className="h-10 md:h-14 w-auto" style={{ filter: 'brightness(0) invert(1)' }} />
            <img src="/images/rollingstone.png" alt="Rolling Stone" className="h-12 md:h-20 w-auto" style={{ filter: 'brightness(0) invert(1)' }} />
          </div>
        </div>
      </div>
    </section>
